...
<body class="m-0 p-0">
    ...
    <div class="container">
        <div class="container fixed-top">
            ...
            <div class="row container position-fixed mt-5">
                <div class="mt-2 mt-xs-0">
        ...
        <div class="d-flex justify-content-center mt-5">
            ...
            <div class="col-3 mt-5">
                <div class="mt-5 container col-3 position-fixed">
           ...
           if ($tmp) {
               ...
               if ($uploadOk == 0) {
                   ...
                   if (move_uploaded_file($_FILES["votre_image"]["tmp_name"], $profil)) {
                        // $req=$cnx->prepare('INSERT INTO admin(Id,Prenom,Nom,Login,Password,Profil) VALUES(?,?,?,?,?,?)');
